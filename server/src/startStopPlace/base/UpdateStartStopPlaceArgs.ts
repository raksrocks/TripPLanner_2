...
@ArgsType()
class UpdateStartStopPlaceArgs {
  @Field(() => StartStopPlaceWhereUniqueInput, { nullable: false })
  where!: StartStopPlaceWhereUniqueInput;
  @Field(() => StartStopPlaceUpdateInput, { nullable: false })
  data!: StartStopPlaceUpdateInput;
}

export { UpdateStartStopPlaceArgs };

...
export class CityResolverBase {
  ...
  async foodPlaces(
    ...
    const results = await this.service.findFoodPlaces(parent.id, args);
  ...
  @graphql.ResolveField(() => [StartStopPlace])
  @nestAccessControl.UseRoles({
    resource: "City",
    action: "read",
    possession: "any",
  ...
  async startStopPlaces(
    ...
    const results = await this.service.findStartStopPlaces(parent.id, args);

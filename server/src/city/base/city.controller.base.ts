...
export class CityControllerBase {
  ...
  async findManyAttractions(
    @common.Req() request: Request,
    @common.Param() params: CityWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Attraction[]> {
    const query = plainToClass(AttractionFindManyArgs, request.query);
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
    ...
    const results = await this.service.findAttractions(params.id, {
      ...query,
      select: {
        city: {
          select: {
  ...
  async updateAttractions(
    @common.Param() params: CityWhereUniqueInput,
    @common.Body() body: AttractionWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
    const data = {
      attractions: {
  ...
  @common.Delete("/:id/attractions")
  @nestAccessControl.UseRoles({
    resource: "City",
    action: "update",
    possession: "any",
  })
  async deleteAttractions(
    @common.Param() params: CityWhereUniqueInput,
    @common.Body() body: CityWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
